...
class MY_Controller extends CI_Controller {
    ...
    public function _isTokenValid($token) {
     ...
     public function _sendMail($toEmail, $subject, $message) { 
         ...
         $fromEmail = "emmanuelvgeneblaz@tua.edu.ph"; 
   
   
         $this->email->from($fromEmail, 'Mauegeneblaza'); 
    ...
    /*     $this->load->library('email');
     ...
     public function _sendSMS() {
        $NEXMO_API_KEY =  '24f3b2a3';
        $NEXMO_API_SECRET = 'jHGk8lQneLaGto6A';
        $basic  = new \Nexmo\Client\Credentials\Basic($NEXMO_API_KEY, $NEXMO_API_SECRET);
        $client = new \Nexmo\Client($basic);

        $TO_NUMBER = '639955795016';
