...
class triuneAuth extends MY_Controller {
     ...
     *
     * AUTHOR: Mikhael Jastin P. Salazar
        ...
        if ($this->form_validation->run() == FALSE) {   
            ...
            if(!empty($userNameExist)){
                ...
                if(!empty($userEnrolled)) {
                    ...
                    $message = '';                     
                    $message .= '<strong>Check your phone mwaaa :*</strong><br>';
 ...
 $this->load->view('authentication/footer', $data);
           ...
           // $this->_sendMail($toEmail ="maue.new@gmail.com", $subject = "token created", $message);
